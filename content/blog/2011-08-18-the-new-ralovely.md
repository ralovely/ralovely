...
A few weeks ago, I moved the blog over to GitHub, going from an ageing WordPress to a static Jekyll site hosted as a GitHub page. I had fun doing it, but it wasn't enough.  
So here is the fruit of a little over 2 days of work.  
There are a few loose ends, it hasn't even been tested for IE, and one could probably tweak a lot of the little details. It also needs an iOS-optimised version, but at least it's here.

For the graphically oriented among you:
* Font is Futura PT, thanks to the awesome [Typekit](http://typekit.com) service.
