...
I didn't really give the Flash family a spin ; Ruby and Rails were the Hot thing on the web and, after reading a few lines of code, I felt closer to Ruby than ActionScript.

Two times, I failed.
PHP and the dozen ongoing projects grabbed me back.  
...
Sure, you have to embrace a way of thinking, constraints and predefined methods, but the reward is mighty.  
...
Over the next few posts, I will try and tell a story, share resources, code and advice (sometimes learned painfully), in the hope it can help another nubyist to bootstrap.
